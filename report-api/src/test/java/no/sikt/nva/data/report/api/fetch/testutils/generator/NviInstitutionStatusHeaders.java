...
public final class NviInstitutionStatusHeaders {
    ...
    public static String PUBLICATION_CHANNEL_LEVEL = "KVALITETSNIVAKODE";
    public static String CONTRIBUTOR_IDENTIFIER = "PERSONLOPENR";
    ...
    public static final String PUBLICATION_TYPE_CHANNEL_LEVEL_POINTS = "VEKTINGSTALL";
