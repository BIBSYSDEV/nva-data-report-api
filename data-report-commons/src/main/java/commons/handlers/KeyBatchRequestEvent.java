...
@JacocoGenerated // Used in abstract class BulkTransformerHandler, subclasses tested in modules
// bulk-export and bulk-load
public class KeyBatchRequestEvent implements JsonSerializable, EventBody {
  ...
  @JsonCreator
  public KeyBatchRequestEvent(
      @JsonProperty(START_MARKER_JSON_NAME) String startMarker,
