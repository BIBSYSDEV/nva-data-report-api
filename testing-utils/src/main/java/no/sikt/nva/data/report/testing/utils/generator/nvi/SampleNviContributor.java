...
public record SampleNviContributor(String id, List<SampleNviOrganization> affiliations) {
  ...
  public NviContributorGenerator toModel() {
    ...
    affiliations.stream().map(SampleNviOrganization::toModel).forEach(contributor::withAffiliation);
    return contributor;
  }
