...
public final class StringUtils {
  ...
  public static String buildString(ScanningResult scanningResult, List<String> dataLines) {
    var sortedData =
        new StringBuilder(scanningResult.header())
            .append(LINE_BREAK)
  ...
  public static String printAsString(
      CSVFormat format, CSVParser csvParser, Collection<CSVRecord> recordList) throws IOException {
  ...
  public static StringBuilder addNumberOfDelimiters(
      StringBuilder stringBuilder, int numberOfDelimiters) {
