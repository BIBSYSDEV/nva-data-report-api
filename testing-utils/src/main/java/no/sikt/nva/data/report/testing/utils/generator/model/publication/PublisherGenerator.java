...
public class PublisherGenerator extends TripleBasedBuilder implements PublicationContext {
  ...
  private static final Resource PUBLISHER =
      new ResourceImpl(Constants.ONTOLOGY_BASE_URI + "Publisher");
  ...
  public PublisherGenerator(UUID identifier) {
    ...
    this.subject = model.createResource(Constants.publisherUri(identifier));
