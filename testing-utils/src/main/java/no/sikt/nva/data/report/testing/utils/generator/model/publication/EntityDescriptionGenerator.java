...
public class EntityDescriptionGenerator extends TripleBasedBuilder {
  ...
  private static final Property MAIN_TITLE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "mainTitle");
  private static final Resource ENTITY_DESCRIPTION =
      new ResourceImpl(Constants.ONTOLOGY_BASE_URI + "EntityDescription");
  private static final Property REFERENCE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "reference");
  private static final Property PUBLICATION_DATE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "publicationDate");
