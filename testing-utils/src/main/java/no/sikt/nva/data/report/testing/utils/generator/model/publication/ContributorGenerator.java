...
public class ContributorGenerator extends TripleBasedBuilder {
  ...
  private static final Property SEQUENCE_NUMBER =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "sequence");
  private static final Property ROLE = new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "role");
  private final Model model;
  private static final Resource CONTRIBUTOR =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "Contributor");
  private static final Property IDENTITY =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "identity");
