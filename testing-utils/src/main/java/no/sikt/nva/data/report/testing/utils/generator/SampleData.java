...
public class SampleData {
  ...
  private static final List<String> AFFILIATION_HEADERS =
      List.of(
          PUBLICATION_ID,
          STATUS,
          ...
          GROUP_ID,
          MODIFIED_DATE);
  private static final List<String> FUNDING_HEADERS =
      List.of(
          PUBLICATION_ID,
          STATUS,
          PUBLICATION_IDENTIFIER,
          ...
          FUNDING_NAME,
          MODIFIED_DATE);
  private static final List<String> PUBLICATION_HEADERS =
      List.of(
          PUBLICATION_ID,
          STATUS,
          PUBLICATION_TITLE,
          ...
          PUBLICATION_IDENTIFIER,
          MODIFIED_DATE);
  private static final List<String> CONTRIBUTOR_HEADERS =
      List.of(
          PUBLICATION_ID,
          STATUS,
          PUBLICATION_IDENTIFIER,
          ...
          CONTRIBUTOR_ROLE,
          MODIFIED_DATE);
  private static final List<String> IDENTIFIER_HEADERS =
      List.of(
          PUBLICATION_ID,
          STATUS,
          PUBLICATION_IDENTIFIER,
  ...
  private void sortContributors(List<SampleNviCandidate> expectedCandidates) {
    expectedCandidates.forEach(
        candidate -> candidate.publicationDetails().contributors().sort(this::sortByContributor));
  }
