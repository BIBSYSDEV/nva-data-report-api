...
public class CandidateGenerator extends TripleBasedBuilder {
  ...
  private static final Resource NVI_CANDIDATE =
      new ResourceImpl(Constants.ONTOLOGY_BASE_URI + "NviCandidate");
  private static final Property PUBLICATION_DETAILS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "publicationDetails");
  private static final Property MODIFIED_DATE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "modifiedDate");
  private static final Property IDENTIFIER =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "identifier");
  private static final Property APPROVAL =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "approval");
  private static final Property IS_APPLICABLE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "isApplicable");
  private static final Property POINTS = new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "points");
  private static final Property PUBLICATION_TYPE_CHANNEL_LEVEL_POINTS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "publicationTypeChannelLevelPoints");
  private static final Property CREATOR_SHARE_COUNT =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "creatorShareCount");
  private static final Property INTERNATIONAL_COLLABORATION_FACTOR =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "internationalCollaborationFactor");
  private static final Property REPORTED =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "reported");
  private static final Property REPORTING_PERIOD =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "reportingPeriod");
  private static final Property GLOBAL_APPROVAL_STATUS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI + "globalApprovalStatus");
  ...
  public CandidateGenerator(String id, String identifier, String modifiedDate) {
    ...
    model.add(
        subject,
        MODIFIED_DATE,
        model.createTypedLiteral(modifiedDate, XSDDateTimeType.XSDdateTime));
  ...
  public CandidateGenerator withPublicationTypeChannelLevelPoints(
  ...
  public CandidateGenerator withInternationalCollaborationFactor(
