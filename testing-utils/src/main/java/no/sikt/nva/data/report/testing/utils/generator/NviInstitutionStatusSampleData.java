...
public final class NviInstitutionStatusSampleData {
  ...
  public static final List<String> NVI_INSTITUTION_STATUS_HEADERS =
      List.of(
          REPORTING_YEAR,
  ...
  public static String generateExpectedNviInstitutionResponse(
    ...
    contributor
        ...
        .forEach(
            affiliation ->
                generateExpectedNviInstitutionResponse(
                    stringBuilder, contributor, affiliation, candidate, publication));
    return stringBuilder.toString();
  }

  private static void generateExpectedNviInstitutionResponse(
    ...
    stringBuilder
        .append(candidate.reportingPeriod())
        .append(DELIMITER)
        .append(publication.getIdentifier())
        .append(DELIMITER)
        .append(publication.getDate().year())
        .append(DELIMITER)
        .append(getExpectedApprovalStatusValue(approval.approvalStatus()))
        .append(DELIMITER)
        .append(publication.getPublicationCategory())
        .append(DELIMITER)
        .append(
            publication
                .getChannel()
                .getType()
                .substring(publication.getChannel().getType().indexOf('#') + 1))
        .append(DELIMITER)
        .append(publication.getChannel().getPrintIssn())
        .append(DELIMITER)
        .append(getExpectedPublicationChannelLevel(publication))
        .append(DELIMITER)
        .append(UriWrapper.fromUri(contributor.id()).getLastPathElement())
        .append(DELIMITER)
        .append(affiliation.getOrganizationNumber())
        .append(DELIMITER)
        .append(affiliation.getSubUnitOneNumber())
        .append(DELIMITER)
        .append(affiliation.getSubUnitTwoNumber())
        .append(DELIMITER)
        .append(affiliation.getSubUnitThreeNumber())
        .append(DELIMITER)
        .append(identity.name())
        .append(DELIMITER)
        .append(identity.name())
        .append(DELIMITER)
        .append(publication.getChannel().getName())
        .append(DELIMITER)
        .append(publication.getMainTitle())
        .append(DELIMITER)
        .append(getExpectedApprovalStatusValue(candidate.globalApprovalStatus()))
        .append(DELIMITER)
        .append(candidate.publicationTypeChannelLevelPoints())
        .append(DELIMITER)
        .append(candidate.internationalCollaborationFactor())
        .append(DELIMITER)
        .append(NviTestUtils.getExpectedPointsForAffiliation(affiliation, contributor, approval))
        .append(CRLF.getString());
  }

  private static SampleIdentity getExpectedContributorIdentity(
      SampleNviContributor contributor, SamplePublication publication) {
  ...
  private static SampleApproval getExpectedApproval(
      SampleNviOrganization affiliation, SampleNviCandidate candidate) {
  ...
  private static boolean isApprovalForOrganization(
      SampleApproval approval, SampleNviOrganization organization) {
    return approval.institutionId().toString().equals(organization.getTopLevelOrganization());
  }
}
