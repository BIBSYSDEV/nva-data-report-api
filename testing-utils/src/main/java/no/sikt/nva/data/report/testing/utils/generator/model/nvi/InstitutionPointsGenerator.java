...
public class InstitutionPointsGenerator extends TripleBasedBuilder {
  ...
  public static final PropertyImpl CREATOR_AFFILIATION_POINTS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "creatorAffiliationPoints");
  private static final Property INSTITUTION_POINTS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "InstitutionPoints");
