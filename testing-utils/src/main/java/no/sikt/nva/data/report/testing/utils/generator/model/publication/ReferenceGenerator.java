...
public class ReferenceGenerator extends TripleBasedBuilder {
  ...
  private static final Resource REFERENCE =
      new ResourceImpl(Constants.ONTOLOGY_BASE_URI + "Reference");
  private static final Property PUBLICATION_CONTEXT =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "publicationContext");
  private static final Property PUBLICATION_INSTANCE =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "publicationInstance");
  ...
  public ReferenceGenerator withPublicationInstance(
      PublicationInstanceGenerator publicationInstance) {
