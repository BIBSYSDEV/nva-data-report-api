...
public class ApprovalGenerator extends TripleBasedBuilder {
  ...
  public static final PropertyImpl POINTS_PROPERTY =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "points");
  public static final PropertyImpl APPROVAL_STATUS =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "approvalStatus");
  public static final PropertyImpl INSTITUTION_ID =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "institutionId");
  public static final Property INVOLVED_ORGANIZATION =
      new PropertyImpl(Constants.ONTOLOGY_BASE_URI, "involvedOrganization");
  ...
  public ApprovalGenerator withInvolvedOrganizations(Set<String> involvedOrganizations) {
    involvedOrganizations.forEach(
        organization -> model.add(subject, INVOLVED_ORGANIZATION, organization));
    return this;
  }
